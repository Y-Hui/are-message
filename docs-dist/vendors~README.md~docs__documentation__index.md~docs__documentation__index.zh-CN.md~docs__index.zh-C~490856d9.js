  ...
  [1],
  {
    ...
    ZpkN: function (e, t, n) {
                        ...
                        if (!(S instanceof l)) {
                          if (b && E != n.length - 1) {
                            ...
                            for (
                              ...
                              (I += n[T].length), A >= I && (++E, (k = I))
                            if (n[E] instanceof l) continue
                            ;(R = T - E), (S = e.slice(k, I)), (w.index -= k)
                          } else {
                            p.lastIndex = 0
                            w = p.exec(S)
                            var R = 1
      ...
      ;(o.languages.markup = {
        ...
        (o.languages.python['string-interpolation'].inside[
          'interpolation'
        ].inside.rest = o.languages.python),
            ...
            while ((i = a[s]++) < r[s]) {
              ...
              if (
                ('string' === typeof p
                  ? ((c = s > 0 ? c : ['plain']), (u = p))
                  : ((c = m(c, p.type)),
                    p.alias && (c = m(c, p.alias)),
                    (u = p.content)),
                'string' === typeof u)
              ) {
                var g = u.split(f),
                  h = g.length
                o.push({ types: c, content: g[0] })
                for (var y = 1; y < h; y++)
                  b(o), l.push((o = [])), o.push({ types: c, content: g[y] })
      ...
      var k = (function (e) {
          function t() {
            ...
            e.apply(this, n),
              p(this, 'getThemeDict', function (e) {
                if (
                  void 0 !== t.themeDict &&
                  e.theme === t.prevTheme &&
              ...
              p(this, 'getLineProps', function (e) {
                var n = e.key,
                  a = e.className,
                  r = e.style,
                  i = E(e, ['key', 'className', 'style', 'line']),
                  s = i,
                  o = g({}, s, {
                ...
                return (
                  ...
                  void 0 !== r &&
                    (o.style = void 0 !== o.style ? g({}, o.style, r) : r),
                  void 0 !== n && (o.key = n),
                  a && (o.className += ' ' + a),
                  o
                )
              }),
              p(this, 'getStyleForToken', function (e) {
                var n = e.types,
                  a = e.empty,
                  r = n.length,
              ...
              p(this, 'getTokenProps', function (e) {
                var n = e.key,
                  a = e.className,
                  r = e.style,
                  i = e.token,
                  s = E(e, ['key', 'className', 'style', 'token']),
                  o = s,
                  l = g({}, o, {
              ...
              p(this, 'tokenize', function (e, t, n, a) {
      ...
      n('qHiR'),
        ...
        (t['a'] = (e) => {
          ...
          return s.a.createElement(
            ...
            s.a.createElement(
              S,
              Object(a['a'])({}, d, { code: t, language: n, theme: void 0 }),
              (e) => {
                var n = e.className,
                  a = e.style,
                  r = e.tokens,
                ...
                return s.a.createElement(
                  ...
                  r.map((e, t) =>
                    s.a.createElement(
                      ...
                      i({ line: e, key: t }),
                      e.map((e, t) =>
                        s.a.createElement('span', l({ token: e, key: t })),
                      ),
                    ),
                  ),
                )
